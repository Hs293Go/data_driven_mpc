...
from .internal import CustomKernelFunctions, nll_func


def minimization_worker(x_train, y_train, x_0, bounds):
    try:
        res = minimize(
            lambda x: nll_func(x_train, y_train, x),
            x0=x_0,
            bounds=bounds,
            method="L-BFGS-B",
        )
...
class CustomGPRegression:
    ...
    def fit(self, x_train, y_train):
        ...
        optima = [
            minimization_worker(x_train, y_train, it, log_bounds)
